...
export class CourseConfigLoader {
    ...
    static createCourseConfigList(): CourseConfig[] {
        return [
            ...
            {
                courseId: 'course_mul_10',
                courseName: 'かけ算&nbsp;10～19',
                operator: 'multiplication',
                item2: { min: 0, max: 9 },
                item1: { min: 10, max: 19 },
            },
            {
                courseId: 'course_mul_20',
                courseName: 'かけ算&nbsp;20～29',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 20, max: 29 },
            },
            {
                courseId: 'course_mul_30',
                courseName: 'かけ算&nbsp;30～39',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 30, max: 39 },
            },
            {
                courseId: 'course_mul_40',
                courseName: 'かけ算&nbsp;40～49',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 40, max: 49 },
            },
            {
                courseId: 'course_mul_50',
                courseName: 'かけ算&nbsp;50～59',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 50, max: 59 },
            },
            {
                courseId: 'course_mul_60',
                courseName: 'かけ算&nbsp;60～69',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 60, max: 69 },
            },
            {
                courseId: 'course_mul_70',
                courseName: 'かけ算&nbsp;70～79',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 70, max: 79 },
            },
            {
                courseId: 'course_mul_80',
                courseName: 'かけ算&nbsp;80～89',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 80, max: 89 },
            },
            {
                courseId: 'course_mul_90',
                courseName: 'かけ算&nbsp;90～99',
                operator: 'multiplication',
                item1: { min: 0, max: 9 },
                item2: { min: 90, max: 99 },
            },
